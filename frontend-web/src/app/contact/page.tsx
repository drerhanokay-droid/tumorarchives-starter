...
export default function ContactPage() {
  ...
  return (
    <DocsShell
      eyebrow="Iletisim"
      title="Erken erisim, pilot kurulum ve kurum gorusmeleri"
      description="Bu form pazarlama CTA degil; gercek basvuru toplama akisidir. Talep backend'e kaydedilir ve panel inbox'ta islenebilir."
      sideTitle="Basvuru Konsolu"
      sideItems={[
        'Kurum veya uzmanlik bilgisi',
        'Kullanim tipi ve cihaz olcegi',
        'ORCID durumu',
        'Pilot veya akademik kullanim notu',
      ]}
      sideNote="Bir sonraki adimda bu akis e-posta bildirimi ve admin atama kurallariyla genisletilebilir."
    >
      <section className="panel-card docs-content-card">
        <form className="form-grid" onSubmit={onSubmit}>
          ...
          <label>
            <span>Not</span>
            <textarea value={form.message} onChange={(e) => setForm((current) => ({ ...current, message: e.target.value }))} placeholder="Tumor tipi, kullanim senaryosu, pilot beklentisi..." />
          </label>
